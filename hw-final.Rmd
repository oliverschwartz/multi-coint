...
setwd("C:/Users/dangi/Dropbox/Classes/orf445/multi-coint") # Dan TODO: change this dir. 
...
rolling_stats <- function(x, y, wlen) {
  ...
  for (t in 2:N) {
    ...
    std_x[t] <- mean((x[start_idx:t]-ema_x[t])**2)
    std_y[t] <- mean((y[start_idx:t]-ema_y[t])**2)
...
```{r}
plot(mid_by_sym[["GEM1"]])
plot(pairwise_stats[["GEH1,GEM1"]]$std_y)
```
