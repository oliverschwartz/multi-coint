...
saveRDS(pairwise_stats, file="cache/pairwise_stats.rds")
```

At every point in time, we want to compute the eigenvectors of the correlation matrix. We then project each point into this eigenvector space.
```{r}
for (t in 5000:NSEC) {
  
  # Get z-scores of all prices for time t. 
