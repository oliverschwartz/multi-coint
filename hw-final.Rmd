...
Computing exponential correlations is a little more involved. Given the exponential average at some time $t=n$, $\frac{A_n}{B_n}$, the exponential covariance $Cov_e$ is simply the weighted mean from the beginning of time relative to the current exponential average. 
$$
