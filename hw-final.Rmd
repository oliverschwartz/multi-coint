...
- Daniel Gitelman^[Princeton University, danielg@princeton.edu]
date: "4/28/2021"
output:
...
`TODO`: look at signular values over time, plot them. 
If they stabilize --> mean reverting
If they keep increasing --> random walk. 
